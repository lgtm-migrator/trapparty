...
FROM node:16.6.2-buster@sha256:678cad87833f51615213547acb719e951569816db7bb0e2bb7da10cbfccc976c AS development
...
# `node-zopfli-es` and `sqitch` require at least buster.
# `node-zopfli-es` requires non-slim.
FROM node:16.6.2-buster@sha256:678cad87833f51615213547acb719e951569816db7bb0e2bb7da10cbfccc976c AS build
...
FROM node:16.6.2-buster-slim@sha256:7c7cb112b60b8550eacab6647afe7bf4fa89cd20e08dceaece500612e742583d AS production
