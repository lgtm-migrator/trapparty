...
FROM node:16.5.0-buster@sha256:50e52d596ee076b8c104b7f193f5e2d50a6920952b7f1bc3008d5618081508c9 AS development
...
# `node-zopfli-es` and `sqitch` require at least buster.
# `node-zopfli-es` requires non-slim.
FROM node:16.5.0-buster@sha256:50e52d596ee076b8c104b7f193f5e2d50a6920952b7f1bc3008d5618081508c9 AS build
...
FROM node:16.5.0-buster-slim@sha256:7b42ebe21b94e0a64af337548f2b71cf8f1d652c5e4f0e56017fb0a055b076d1 AS production
